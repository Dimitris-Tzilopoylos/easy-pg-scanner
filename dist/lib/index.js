...
var _this = this;
var _a = require("./connection"),
  init = _a.init,
  withConnection = _a.withConnection;
var Queries = require("./queries");
var formatColumn = function (_a) {
  var column = _a.column,
    indexes = _a.indexes,
    foreignKeys = _a.foreignKeys,
    checkConstraints = _a.checkConstraints;
  return {
    ...
    unique: (indexes || []).some(function (idx) {
      return (
        idx.is_unique &&
        !idx.is_primary &&
        idx.indexed_columns.some(function (x) {
    ...
    foreign: (foreignKeys || []).find(function (key) {
      return key.column_name === column.column_name;
    }),
...
var loadDatabase = function (connectionOptions) {
                ...
                return __generator(this, function (_a) {
                  switch (_a.label) {
                    case 0:
                      return [
                        4 /*yield*/,
                        client.query(Queries.listSchemas(true)),
                      ];
                    case 1:
                        ...
                        return __generator(this, function (_b) {
                          switch (_b.label) {
                            ...
                            case 3:
                                ...
                                return __generator(this, function (_c) {
                                  switch (_c.label) {
                                    ...
                                    case 4:
                                      ...
                                      schemaConfig.tables[i].foreignKeys =
                                        foreignKeys;
                                      schemaConfig.tables[i].columns =
                                      ...
                                      schemaConfig.tables[i].triggers =
                                        triggers;
                                      return [2 /*return*/];
                                  }
                                });
                              ...
                              _b.label = 4;
                            case 4:
                              if (!(i < schemaConfig.tables.length))
                                return [3 /*break*/, 7];
